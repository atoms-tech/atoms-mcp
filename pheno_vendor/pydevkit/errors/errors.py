...
Provides structured error classes and normalization utilities
for consistent error handling across applications.
"""
...
def normalize_error(err: Exception | str, fallback_message: str) -> ApiError:
    ...
    Args:
        err: Exception or error string to normalize
        fallback_message: Message to use if error is unspecified

    Returns:
        Normalized ApiError instance
    """
