...
This module provides comprehensive file type detection, categorization,
and token estimation for various file types.
"""
...
PROGRAMMING_EXTENSIONS = PROGRAMMING_LANGUAGES
