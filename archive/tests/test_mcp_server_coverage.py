...
class TestMCPServerInitialization:
    ...
    async def test_server_starts_successfully(self):
        ...
        # Should be ready to accept connections
        mock_app.state = {"initialized": True}
    ...
    async def test_tools_registered(self):
        ...
        mock_tools = {tool: MagicMock() for tool in expected_tools}
        
        # Verify all tools exist
        for tool in expected_tools:
            assert tool in mock_tools
            assert mock_tools[tool] is not None
    ...
    async def test_tool_schemas_valid(self):
        ...
        tools_with_schemas = {
            ...
            "entity_operation": {
                ...
                "description": "Create, read, update entities",
                "inputSchema": {
                    "type": "object",
                    "properties": {
                        "operation": {"type": "string"},
            ...
            "relationship_operation": {
                ...
                "inputSchema": {
                    ...
                    "required": ["operation", "relationship_type"]
                }
            },
            "workflow_execute": {
        ...
        for tool_name, schema in tools_with_schemas.items():
    ...
    async def test_server_handles_missing_env_gracefully(self):
        ...
        with patch.dict("os.environ", {}, clear=True):
            ...
            config = {
                "SUPABASE_URL": None,
                "AUTHKIT_API_KEY": None,
            }
            
            # Should initialize with defaults
            assert config["SUPABASE_URL"] is None
            # Optional services should be skipped
            assert config["AUTHKIT_API_KEY"] is None
