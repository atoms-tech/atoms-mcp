...
def serialize_to_markdown(data: Any, config: SerializerConfig | None = None) -> str:
...
def _dict_to_markdown(d: dict[str, Any], indent: int = 0, config: SerializerConfig | None = None) -> str:
...
def _format_regular_dict(d: dict[str, Any], indent: int, config: SerializerConfig) -> str:
...
def _list_to_markdown(lst: list[Any], indent: int = 0, config: SerializerConfig | None = None) -> str:
