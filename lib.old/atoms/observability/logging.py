...
class StructuredFormatter(logging.Formatter):
    ...
    def __init__(
        self, include_context: bool = True, include_stack_trace: bool = True, timestamp_format: str = "iso8601"
    ):
        super().__init__()
...
class AtomLogger:
    ...
    def debug(
        self, message: str, extra_fields: dict[str, Any] | None = None, performance: PerformanceMetric | None = None
    ) -> None:
        """Log debug message."""
    ...
    def exception(self, message: str, extra_fields: dict[str, Any] | None = None) -> None:
...
def get_logger(name: str, level: str | LogLevel = LogLevel.INFO, json_format: bool = True) -> AtomLogger:
    """
    ...
    """
    return AtomLogger(name=name, level=level, enable_console=True, enable_file=False, json_format=json_format)
