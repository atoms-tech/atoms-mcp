...
class RequestTrackingMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next: Callable) -> Response:
        ...
        correlation_id = request.headers.get(self.correlation_id_header, str(uuid4()))
        ...
        # Set logging context
        with LogContext(
            correlation_id=correlation_id, user_id=user_id, session_id=session_id, request_path=request.url.path
        ):
            ...
            try:
                ...
                record_error(error_type=type(e).__name__, source="middleware")
...
class ErrorTrackingMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next: Callable) -> Response:
        ...
        try:
            ...
            # Record error metric
            record_error(error_type=type(e).__name__, source="unhandled_exception")
...
class ContextPropagationMiddleware(BaseHTTPMiddleware):
    ...
    def __init__(self, app: ASGIApp, propagate_headers: list | None = None):
        super().__init__(app)
