...
class TestMetrics:
    ...
    def test_histogram_observations(self):
        ...
        histogram = Histogram("test_histogram", "Test histogram", buckets=[0.1, 0.5, 1.0, 5.0])
...
class TestHealthChecks:
    ...
    async def test_custom_health_check_success(self):
        ...
        check = CustomHealthCheck(
            name="test_check", component_type=ComponentType.INTERNAL_SERVICE, check_func=check_func, timeout_seconds=1.0
        )
    ...
    async def test_custom_health_check_failure(self):
        ...
        check = CustomHealthCheck(
            name="test_check_fail", component_type=ComponentType.INTERNAL_SERVICE, check_func=check_func
        )
    ...
    async def test_custom_health_check_timeout(self):
        ...
        check = CustomHealthCheck(
            name="slow_check", component_type=ComponentType.INTERNAL_SERVICE, check_func=slow_check, timeout_seconds=0.1
        )
    ...
    async def test_custom_health_check_exception(self):
        ...
        check = CustomHealthCheck(
            name="exception_check", component_type=ComponentType.INTERNAL_SERVICE, check_func=failing_check
        )
...
class TestWebhooks:
    ...
    def test_webhook_config_event_filtering(self):
        ...
        config = WebhookConfig(
            ...
            name="test_webhook",
            event_types=[WebhookEventType.ERROR_OCCURRED, WebhookEventType.WARNING_OCCURRED],
        )
    ...
    async def test_webhook_client_send(self):
        ...
        config = WebhookConfig(
            url="https://httpbin.org/post", name="test_webhook", retry_attempts=1, timeout_seconds=5.0
        )
