...
class DataGenerator:
    ...
    def requirement_data(title: str | None = None, document_id: str | None = None, **kwargs) -> dict[str, Any]:
        ...
        return {
            ...
            **{k: v for k, v in kwargs.items()
               if k not in ["title", "description", "priority", "status", "block_id"]}
        }
    ...
    def test_data(name: str | None = None, project_id: str | None = None, **kwargs) -> dict[str, Any]:
        ...
        return {
            ...
            **{k: v for k, v in kwargs.items()
               if k not in ["name", "description", "priority", "status"]}
        }
...
class EntityFactory:
    ...
    @staticmethod
    def requirement(document_id: str | None = None, block_id: str | None = None,
                    title: str | None = None, **kwargs) -> dict[str, Any]:
    ...
    @staticmethod
    def test_entity(project_id: str | None = None, requirement_id: str | None = None,
