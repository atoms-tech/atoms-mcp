...
# Import from framework __init__ to get mcp-QA versions
from . import (
    TestCache,
    get_test_registry,
    ConsoleReporter,
...
from .test_logging_setup import QuietLogger
...
class TestRunner:
    ...
    async def _initialize_connection_pool(self):
        ...
        try:
            ...
            # FastMCP Client stores endpoint in ._client.mcp_url or similar
            ...
            if hasattr(client, 'mcp_url'):
                ...
                # Fallback - try to extract from any URL attribute
    ...
    async def run_all(self, categories: Optional[List[str]] = None) -> Dict[str, Any]:
        ...
        if self.parallel and self.verbose:
