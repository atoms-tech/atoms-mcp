...
class TestProjectLifecycle:
    ...
    async def test_complete_project_lifecycle(self, mcp_client):
        ...
        for test_data in test_cases:
            test_result = await call_mcp(mcp_client, "entity_tool", {
                "operation": "create",
                "entity_type": "test",
                "data": test_data
            })
        ...
        for doc_data in documents:
            doc_result = await call_mcp(mcp_client, "entity_tool", {
                "operation": "create",
        ...
        project_update_result = await call_mcp(mcp_client, "entity_tool", {
            "operation": "update",
            "entity_type": "project",
        ...
        final_project = await call_mcp(mcp_client, "entity_tool", {
            "operation": "get",
            "entity_type": "project",
            "entity_id": project_id
        })
    ...
    async def test_project_lifecycle_with_relationships(self, mcp_client):
        ...
        link_result = await call_mcp(mcp_client, "relationship_tool", {
            "operation": "link",
        ...
        check_result = await call_mcp(mcp_client, "relationship_tool", {
            "operation": "check",
            "relationship_type": "tests_requirement",
            "source_type": "test",
            "source_id": test_id,
        ...
        # List relationships
        list_result = await call_mcp(mcp_client, "relationship_tool", {
            "operation": "list",
            "relationship_type": "tests_requirement",
            "source_type": "test",
            "source_id": test_id
