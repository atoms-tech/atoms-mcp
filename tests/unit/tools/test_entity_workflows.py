"""Workflow management operations for entities.

This module contains tests for workflow CRUD and execution operations.

Run with: pytest tests/unit/tools/test_entity_workflows.py -v
"""
