...
async def test_organization_list_operations(client_adapter):
    ...
    assert ResponseValidator.has_any_fields(result["response"], ["organizations", "items", "data"]), (
...
async def test_organization_create_operations(client_adapter):
    ...
    try:
        result = await client_adapter.call_tool(
            "entity_tool", {"entity_type": "organization", "operation": "create", "data": test_data}
        )
        ...
        assert ResponseValidator.has_fields(created_org, ["id", "name", "created_at", "updated_at"]), (
        ...
        if created_org:
            await client_adapter.call_tool(
                "entity_tool", {"entity_type": "organization", "operation": "delete", "entity_id": created_org["id"]}
            )
...
async def test_organization_read_operations(client_adapter):
    ...
    try:
        ...
        # Read organization
        result = await client_adapter.call_tool(
            "entity_tool", {"entity_type": "organization", "operation": "read", "entity_id": created_org["id"]}
        )
...
async def test_organization_update_operations(client_adapter):
    ...
    try:
        ...
        result = await client_adapter.call_tool(
            "entity_tool",
            {"entity_type": "organization", "operation": "update", "entity_id": created_org["id"], "data": update_data},
        )
...
async def test_organization_delete_operations(client_adapter):
    ...
    try:
        ...
        # Verify deletion
        read_result = await client_adapter.call_tool(
            "entity_tool", {"entity_type": "organization", "operation": "read", "entity_id": created_org["id"]}
        )
        ...
        if created_org:
            try:
                await client_adapter.call_tool(
                    "entity_tool",
                    {"entity_type": "organization", "operation": "delete", "entity_id": created_org["id"]},
                )
            except Exception:
...
async def test_project_list_operations(client_adapter):
    ...
    assert ResponseValidator.has_any_fields(result["response"], ["projects", "items", "data"]), (
...
async def test_project_create_operations(client_adapter):
    ...
    try:
        ...
        result = await client_adapter.call_tool(
            "entity_tool", {"entity_type": "project", "operation": "create", "data": test_data}
        )
        ...
        assert ResponseValidator.has_fields(
            created_project, ["id", "name", "organization_id", "created_at", "updated_at"]
        ...
        if created_project:
            await client_adapter.call_tool(
                "entity_tool", {"entity_type": "project", "operation": "delete", "entity_id": created_project["id"]}
            )
        if created_org:
            await client_adapter.call_tool(
                "entity_tool", {"entity_type": "organization", "operation": "delete", "entity_id": created_org["id"]}
...
async def test_document_list_operations(client_adapter):
    ...
    assert ResponseValidator.has_any_fields(result["response"], ["documents", "items", "data"]), (
...
async def test_document_create_operations(client_adapter):
    ...
    try:
        ...
        result = await client_adapter.call_tool(
            "entity_tool", {"entity_type": "document", "operation": "create", "data": test_data}
        )
        ...
        # Validate required fields
        assert ResponseValidator.has_fields(
            created_document, ["id", "title", "project_id", "created_at", "updated_at"]
        ...
        if created_document:
            await client_adapter.call_tool(
                "entity_tool", {"entity_type": "document", "operation": "delete", "entity_id": created_document["id"]}
            )
        if created_project:
            await client_adapter.call_tool(
                "entity_tool", {"entity_type": "project", "operation": "delete", "entity_id": created_project["id"]}
...
async def test_requirement_list_operations(client_adapter):
    ...
    assert ResponseValidator.has_any_fields(result["response"], ["requirements", "items", "data"]), (
...
async def test_requirement_create_operations(client_adapter):
    ...
    try:
        ...
        document_result = await client_adapter.call_tool(
            "entity_tool", {"entity_type": "document", "operation": "create", "data": document_data}
        )
        ...
        result = await client_adapter.call_tool(
            "entity_tool", {"entity_type": "requirement", "operation": "create", "data": test_data}
        )
        ...
        # Validate required fields
        assert ResponseValidator.has_fields(
            created_requirement, ["id", "title", "document_id", "created_at", "updated_at"]
        ...
        if created_requirement:
            await client_adapter.call_tool(
                "entity_tool",
                {"entity_type": "requirement", "operation": "delete", "entity_id": created_requirement["id"]},
            )
        if created_document:
            await client_adapter.call_tool(
                "entity_tool", {"entity_type": "document", "operation": "delete", "entity_id": created_document["id"]}
...
async def test_test_entity_list_operations(client_adapter):
    ...
    result = await client_adapter.call_tool("entity_tool", {"entity_type": "test", "operation": "list"})

    assert result["success"], "Test entity list operation should succeed"
    assert ResponseValidator.has_any_fields(result["response"], ["tests", "items", "data"]), (
...
async def test_test_entity_create_operations(client_adapter):
    ...
    try:
        ...
        requirement_result = await client_adapter.call_tool(
            "entity_tool", {"entity_type": "requirement", "operation": "create", "data": requirement_data}
        )
        ...
        result = await client_adapter.call_tool(
            "entity_tool", {"entity_type": "test", "operation": "create", "data": test_data}
        )
        ...
        # Validate required fields
        assert ResponseValidator.has_fields(
            created_test, ["id", "title", "requirement_id", "created_at", "updated_at"]
        ...
        if created_test:
            await client_adapter.call_tool(
                "entity_tool", {"entity_type": "test", "operation": "delete", "entity_id": created_test["id"]}
            )
        if created_requirement:
            await client_adapter.call_tool(
                "entity_tool",
...
async def test_invalid_entity_type_error(client_adapter):
    ...
    result = await client_adapter.call_tool("entity_tool", {"entity_type": "invalid_entity", "operation": "list"})
...
async def test_nonexistent_entity_read_error(client_adapter):
    ...
    result = await client_adapter.call_tool(
        "entity_tool", {"entity_type": "organization", "operation": "read", "entity_id": fake_id}
    )
...
async def test_organization_search_operations(client_adapter):
    ...
    result = await client_adapter.call_tool(
        "entity_tool", {"entity_type": "organization", "operation": "search", "query": "test"}
    )
...
async def test_project_search_operations(client_adapter):
    ...
    result = await client_adapter.call_tool(
        "entity_tool", {"entity_type": "project", "operation": "search", "query": "test"}
    )
...
async def test_organization_batch_create_operations(client_adapter):
    ...
    try:
        result = await client_adapter.call_tool(
            "entity_tool", {"entity_type": "organization", "operation": "batch_create", "data": test_data}
        )
        ...
        for org in created_orgs:
            ...
            assert ResponseValidator.has_fields(org, ["id", "name", "created_at", "updated_at"]), (
                "Created organization should have required fields"
            )
        ...
        for org in created_orgs:
            try:
                await client_adapter.call_tool(
                    "entity_tool", {"entity_type": "organization", "operation": "delete", "entity_id": org["id"]}
                )
            except Exception:
                pass  # Already deleted
