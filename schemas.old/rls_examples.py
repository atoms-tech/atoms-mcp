...
async def example_basic_permission_check():
    ...
    org_record = {"id": "org-456", "name": "Acme Corp", "type": "team"}
...
async def example_prevalidate_before_db_operation():
    ...
    # Data to insert
    new_project = {"name": "My Project", "organization_id": "org-456", "description": "A new project"}
...
async def example_crud_operations():
    ...
    document = {"id": "doc-123", "name": "Requirements Doc", "project_id": "project-789"}
    ...
    new_doc = {"name": "New Document", "project_id": "project-789"}
...
class ExampleTool:
    ...
    async def create_document(self, user_id: str, data: dict):
        ...
        try:
            ...
            return {"success": False, "error": str(e), "message": f"Permission denied: {e.reason}"}
        else:
            return {"success": True, "document": result, "message": "Document created successfully"}
    ...
    async def update_document(self, user_id: str, doc_id: str, data: dict):
        ...
        try:
            ...
            return {"success": True, "document": result, "message": "Document updated successfully"}
