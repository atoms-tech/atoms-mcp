...
class SchemaReporter:
    ...
    def generate_report(self, differences: list[dict[str, Any]], db_schema: dict[str, Any], calculate_schema_hash: Callable[[dict[str, Any]], str]) -> Path:
        """Generate a detailed markdown report."""
        report_file = self.root_dir / f"schema_drift_report_{datetime.now(tz=UTC).strftime('%Y%m%d_%H%M%S')}.md"
